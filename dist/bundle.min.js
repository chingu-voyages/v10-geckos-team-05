...
/*!************************!*\
  !*** ./src/js/data.js ***!
  \************************/
/*! exports provided: default */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config */ "./src/js/config.js");\n/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model */ "./src/js/model.js");\n\n\n/**\n  * Main data object\n  *\n  */\n\nvar data = {};\n/**\n  * Firebase app specifications\n  *\n  */\n\nvar firebaseConfig = {\n  apiKey: "AIzaSyDRi3srKe7hNPvW31HZWzklUEtw0HPSTXo",\n  authDomain: "impressions-prototype.firebaseapp.com",\n  databaseURL: "https://impressions-prototype.firebaseio.com",\n  projectId: "impressions-prototype",\n  storageBucket: "impressions-prototype.appspot.com",\n  messagingSenderId: "1092943872445",\n  appId: "1:1092943872445:web:413024422bce97b6"\n};\n/**\n  * Calls initial data methods\n  *\n  */\n\ndata.init = function () {\n  data.fetchData();\n};\n/**\n * Fetch the data from the API\n *\n * @return {Object} data\n */\n\n\ndata.fetchData = function () {\n  fetch(_config__WEBPACK_IMPORTED_MODULE_0__["default"].apiRoot + _config__WEBPACK_IMPORTED_MODULE_0__["default"].apiKey).then(function (response) {\n    if (response.status !== 200) {\n      console.log(\'Problem! Status Code: \' + response.status);\n      return;\n    }\n\n    return response.json();\n  }).then(function (data) {\n    _model__WEBPACK_IMPORTED_MODULE_1__["default"].render(data);\n  })["catch"](function (err) {\n    console.log(\'Error: \', err);\n  });\n};\n/**\n * firebaseInit - Initialize the firebase db\n *\n * @return {Object} firestore\n */\n\n\ndata.firebaseInit = function () {\n  firebase.initializeApp(firebaseConfig);\n};\n\n/* harmony default export */ __webpack_exports__["default"] = (data);//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/js/data.js\n')},"./src/js/helpers.js":
/*!***************************!*\
  !*** ./src/js/helpers.js ***!
  \***************************/
...
/*!*************************!*\
  !*** ./src/js/model.js ***!
  \*************************/
/*! exports provided: default */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./data */ "./src/js/data.js");\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ "./src/js/helpers.js");\n/* harmony import */ var _view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view */ "./src/js/view.js");\n/**\n * Model file for working with data\n */\n\n\n\n/**\n * Main Model Object\n *\n */\n\nvar model = {};\n/**\n * Initializes the model\n *\n */\n\nmodel.init = function () {\n  _data__WEBPACK_IMPORTED_MODULE_0__["default"].init();\n  model.discoverPaintings();\n  _data__WEBPACK_IMPORTED_MODULE_0__["default"].firebaseInit();\n  model.submitForm();\n};\n/**\n * renderData - returns the data from the fetch call\n *\n *  @return {Object} data\n */\n\n\nmodel.render = function (data) {\n  var collection = data.records;\n  var sizeString = \'?height=600&width=600\';\n  var _iteratorNormalCompletion = true;\n  var _didIteratorError = false;\n  var _iteratorError = undefined;\n\n  try {\n    for (var _iterator = collection[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n      var item = _step.value;\n\n      if (item.images === undefined || item.images.length == 0) {\n        _view__WEBPACK_IMPORTED_MODULE_2__["default"].clearData();\n        model.fetchData();\n      }\n\n      var painting = item.images[0].baseimageurl + sizeString;\n      var credit = item.creditline;\n      var description = item.title;\n      var imgSrc = item.url;\n      _view__WEBPACK_IMPORTED_MODULE_2__["default"].displayImage(painting);\n      _view__WEBPACK_IMPORTED_MODULE_2__["default"].addAltTag(credit);\n      _view__WEBPACK_IMPORTED_MODULE_2__["default"].addImageSrc(imgSrc);\n      _view__WEBPACK_IMPORTED_MODULE_2__["default"].displayDescription(description);\n    }\n  } catch (err) {\n    _didIteratorError = true;\n    _iteratorError = err;\n  } finally {\n    try {\n      if (!_iteratorNormalCompletion && _iterator["return"] != null) {\n        _iterator["return"]();\n      }\n    } finally {\n      if (_didIteratorError) {\n        throw _iteratorError;\n      }\n    }\n  }\n};\n/**\n * discoverPaintings - event listener to pull new painting\n */\n\n\nmodel.discoverPaintings = function () {\n  var discoverBtn = document.getElementById(\'discoverBtn\');\n  discoverBtn.addEventListener(\'click\', _view__WEBPACK_IMPORTED_MODULE_2__["default"].reloadImage);\n};\n/**\n * submitForm - event listener to process impressions\n */\n\n\nmodel.submitForm = function () {\n  var submitButton = document.querySelector(\'#submit\');\n  submitButton.addEventListener(\'click\', model.processForm);\n};\n/**\n * processForm - push the data to the database\n */\n\n\nmodel.processForm = function (e) {\n  e.preventDefault();\n  var firestore = firebase.firestore();\n  var docRef = firestore.doc(\'impressions/testDoc\');\n  var commentEl = _helpers__WEBPACK_IMPORTED_MODULE_1__["default"].getCommentEl();\n  var commentToSave = commentEl.value;\n  docRef.set({\n    comment: commentToSave\n  })["catch"](function (err) {\n    console.log(\'Error!\');\n  });\n  _view__WEBPACK_IMPORTED_MODULE_2__["default"].displayImpression(commentToSave, docRef);\n};\n\n/* harmony default export */ __webpack_exports__["default"] = (model);//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/js/model.js\n')},"./src/js/router.js":
/*!**************************!*\
  !*** ./src/js/router.js ***!
  \**************************/
